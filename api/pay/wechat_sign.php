...
class Wxpayandroid {
	//参数配置
	public $config = array(
		'appid' => "wx4109c37f7d4d8ca8", /*微信开放平台上的应用id*/
		'mch_id' => "1490807392", /*微信申请成功之后邮件中的商户id*/
		'api_key' => "P5A023TOK22IFEV5RJGVX49F45B6XI0I", /*正式密钥*/
		//'api_key' => "489046dee5423612ac587077de88b682", /*沙箱密钥*/
	);
	//服务器异步通知页面路径(必填)
	public $notify_url = '';
	...
	private function createAppPara() {
		$url = "https://api.mch.weixin.qq.com/pay/unifiedorder";					//正式url
		//$url = "https://api.mch.weixin.qq.com/sandboxnew/pay/unifiedorder";			//沙箱url
...
// wechat_sign.php?subject=月卡&orderid=20200103&price=0.01&notify_url=xxx
...
if($type == 1)
{
	...
	$res = $wxpayandroid->Weixinpayandroid($price, $orderid, $notify_url, $subject); //调用weixinpay方法
}
else
{
	$xml = $_GET["xml"];		//xml
